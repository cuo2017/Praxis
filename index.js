...
var db = mongoose.connect("mongodb://127.0.0.1:27017/praxis");
...
app.route('/rmUser').post(userController.rmUser);
app.route('/rmAllUser').get(userController.rmAllUser);
app.route('/udUser').post(userController.udUser);
app.route('/handleUpdate').get(userController.handleUpdate);
app.route('/findUser').post(userController.findUser);
...
// curl -l -H "Content-type: application/json" -X POST -d '{"username":"Yuhao Cai","password":"123456","mobile":"(123) 456-7890","membership":"prime","state":"WA","city":"Seattle","direction":"Project Management","program":"Enterprise Agility","certificate":[],"obsolete":"2","videos":"58","posts":"17"}' localhost:7000/addUser
...
// curl -l -H "Content-type: application/json" -X POST -d '{"username":"Yuhao Cai"}' localhost:7000/findUser
